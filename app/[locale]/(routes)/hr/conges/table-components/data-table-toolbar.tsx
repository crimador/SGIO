...
const TYPES = [
  { label: 'Congé annuel', value: 'Vacation' },
  { label: 'Congé exceptionnel', value: 'Leave' },
  { label: 'Arrêt maladie', value: 'Sick' },
  { label: 'Congé maternité', value: 'Maternity' },
  { label: 'Formation', value: 'Training' },
  { label: 'Augmentation', value: 'Raise' },
