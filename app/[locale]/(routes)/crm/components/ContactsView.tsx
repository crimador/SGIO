...
const ContactsView = ({ data, crmData, canWrite = true }: any) => {
  ...
  return (
    <Card className="overflow-hidden">
          ...
          {canWrite && (
            <Sheet open={open} onOpenChange={setOpen}>
              ...
              <SheetContent className="min-w-[800px] space-y-2">
                <SheetHeader><SheetTitle>Nouveau contact</SheetTitle></SheetHeader>
      ...
      <CardContent className="pt-0">
        {!data || data.length === 0 ? (
          <p className="py-6 text-center text-sm text-gray-400">Aucun contact trouvé.</p>
        ) : (
