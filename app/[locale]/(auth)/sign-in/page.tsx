...
const KekelSun = () => (
  <svg viewBox="0 0 200 170" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-40 h-auto drop-shadow-2xl">
    ...
    {/* Corps du soleil (demi-cercle) */}
    <path d="M55,95 A45,45 0 0 1 145,95 Z" fill="url(#sunBody)" />
    {/* Horizon */}
    <path d="M28,100 Q100,94 172,100" stroke="url(#horizon)" strokeWidth="5" strokeLinecap="round" fill="none" />
  </svg>
);

/* Motif de rayons décoratifs en fond */
const RayPattern = () => (
  <svg className="absolute inset-0 h-full w-full opacity-[0.04]" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <pattern id="rays" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
